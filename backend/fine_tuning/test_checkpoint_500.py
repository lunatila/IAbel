#!/usr/bin/env python3
"""
Teste rápido do checkpoint 500 do treinamento ultra-estável
"""
...
def test_checkpoint_500():
    """Test the checkpoint-500 model"""
    
    print("🧪 Testando checkpoint-500 do treinamento ultra-estável...")
    
    checkpoint_path = "./outputs/ultra_stable_lora_extended/checkpoint-500"
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("✅ Teste do checkpoint-500 concluído!")
        return True
